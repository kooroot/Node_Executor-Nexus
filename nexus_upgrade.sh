...
screen -S "$SESSION_NAME" -m bash -c '
    ...
    # (D) Nexus CLI 설치
    ##################################
    echo "[단계] Nexus CLI 설치 (https://raw.githubusercontent.com/kooroot/Node_Executor-Nexus/refs/heads/main/clinexus.sh)"
    wget https://raw.githubusercontent.com/kooroot/Node_Executor-Nexus/refs/heads/main/clinexus.sh
    chmod +x clinexus.sh
    ./clinexus.sh
